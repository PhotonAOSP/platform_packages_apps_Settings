...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_PHOTON_VERSION = "photon_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_PHOTON_VERSION, "ro.photon.version");
        findPreference(KEY_PHOTON_VERSION).setEnabled(true);
    ...
    public void onResume() {
        ...
        mDevHitCountdown = getActivity().getSharedPreferences(DevelopmentSettings.PREF_FILE,
                Context.MODE_PRIVATE).getBoolean(DevelopmentSettings.PREF_SHOW,
                        android.os.Build.TYPE.equals("eng") || android.os.Build.TYPE.equals("userdebug") || android.os.Build.TYPE.equals("user")) ? -1 : TAPS_TO_BE_A_DEVELOPER;
        mDevHitToast = null;
    }
